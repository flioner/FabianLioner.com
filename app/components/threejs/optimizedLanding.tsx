...
const MetaballsPage = () => {
  ...
  useEffect(() => {
    ...
    renderer.shadowMap.type = THREE.BasicShadowMap; // Simplified shadow map type
    ...
    void main() {
      ...
      // Simplified 3D noise
      float noise3D = noise(vPosition * 500.0); // Reduced frequency for less detail
  ...
  `;
    ...
    const createBlob = () => {
      const sphereGeometry = new THREE.SphereGeometry(1, 96, 96); // Reduced complexity
