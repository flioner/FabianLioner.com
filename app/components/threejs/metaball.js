...
export default function MetaballsPage() {
  return (
    <Canvas dpr={[1, 1.5]} camera={{ position: [0, 0, 5], fov: 55 }}>
      ...
      <Physics gravity={[0, 0, 0]}>
        ...
        >
          ...
          <MetaBall color="indianred" position={[0, 0, 0.01]} />
          <MetaBall color="skyblue" position={[0.01, 0, 0]} />
          <MetaBall color="teal" position={[0, 0.01, 0]} />
          <MetaBall color="orange" position={[0.01, 0, 0]} />
          <MetaBall color="hotpink" position={[0, 0.01, 0]} />
          <MetaBall color="aquamarine" position={[0, 0, 0.01]} />
          <Pointer />
        </MarchingCubes>
      </Physics>
